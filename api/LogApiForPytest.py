...
class LogClient(object):
    PytestLogger = logging.getLogger('pytest')
    SystemName = 'app.pytest'  # 当前系统的名称
    # 控制变量
    ...
    def debug(self, msg):
        self.PytestLogger.debug(msg)
        self.send_log('DEBUG', msg)

    def info(self, msg):
        self.PytestLogger.info(msg)
        self.send_log('INFO', msg)

    def warn(self, msg):
        self.PytestLogger.warning(msg)
        self.send_log('WARNING', msg)

    def error(self, msg):
        self.PytestLogger.error(msg)
        self.send_log('ERROR', msg)

    def critical(self, msg):
        self.PytestLogger.critical(msg)
